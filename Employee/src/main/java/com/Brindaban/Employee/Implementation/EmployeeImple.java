package com.Brindaban.Employee.Implementation;
...
import com.Brindaban.Employee.VO.Department;
import com.Brindaban.Employee.Service.EmployeeService;
...
public class EmployeeImple implements EmployeeService {
	...
	public ResponseTemplate empWithDept(long empId) {
		...
		Department dept = restTemplate.getForObject("http://DEPARTMENT-SERVICE/department/" + dept_id,
				Department.class);
