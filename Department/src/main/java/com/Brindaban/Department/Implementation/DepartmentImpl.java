package com.Brindaban.Department.Implementation;
...
import com.Brindaban.Department.VO.Employee;
import com.Brindaban.Department.VO.RequestTemplate;
import com.Brindaban.Department.Entity.Department;
import com.Brindaban.Department.Repository.DepartmentRepository;
...
public class DepartmentImpl implements DepartmentService {
	...
	public List<RequestTemplate> listWithEmp() {
		...
		while (ir.hasNext()) {
			...
			ResponseEntity<Employee[]> response = restTemplate.getForEntity(
					"http://EMPLOYEE-SERVICE/employee/employee-with-ascname/" + dpt.getId(), Employee[].class);
	...
	public RequestTemplate specificDeptEmployee(long dept_id) {
		...
		ResponseEntity<Employee[]> response = restTemplate.getForEntity(
				"http://EMPLOYEE-SERVICE/employee/employee-with-desc-age/" + department.getId(), Employee[].class);
